...
import org.marker.mushroom.beans.Seed;
...
public class SeedController extends SupportController{


	public SeedController() {
		this.viewPath = "/admin/seed/";
	}
	...
	public ModelAndView list(Page page){
		...
		view.addObject("page", commonDao.findByPage(page.getCurrentPageNo(),10,"select * from "+prefix+"seed order by id desc"));
		return view;
	}
	...
	public ModelAndView edit(@RequestParam("id") long id) {
		...
		view.addObject("seed", commonDao.findById(Seed.class, id));
		return view;
	}
