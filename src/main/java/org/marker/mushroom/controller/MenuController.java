...
public class MenuController extends SupportController {
	...
	public ModelAndView add() {
		...
		view.addObject("menus", commonDao.queryForList("select * from  " + prefix + "user_menu"));
		return view;
	}
	...
	public ModelAndView list() {
		...
		view.addObject("menus", commonDao.queryForList("select * from " + prefix + "user_menu order by sort"));
		return view;
	}
