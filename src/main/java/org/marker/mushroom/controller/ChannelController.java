...
public class ChannelController extends SupportController {
	...
	public String add(HttpServletRequest request) {
		request.setAttribute("channels", dao.queryForList("select * from  " + prefix + "channel"));
	...
	public String edit(HttpServletRequest request) {
		...
		request.setAttribute("channel", dao.queryForMap("select * from  " + prefix + "channel where id=?", id));
		request.setAttribute("channels", dao.queryForList("select * from  " + prefix + "channel"));
	...
	public Object save(Channel channel) {
		if (commonDao.save(channel)) {
			...
			try {
				String path =
					WebRealPathHolder.REAL_PATH + "data" + File.separator + "template" + File.separator + "template.html";
	...
	public ModelAndView list() {
		List<Map<String, Object>> list = commonDao.queryForList(
			"select c.* from  " + prefix + "channel c order by c.id,c.sort asc");
