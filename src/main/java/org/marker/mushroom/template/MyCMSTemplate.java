...
//        
	...
	public void proxyCompile(String tplFileName) throws SystemException, IOException {
		...
		// 构造模模版路径
		String tplFilePath = WebRealPathHolder.REAL_PATH + "themes" + File.separator
			+ syscfg.get(SystemConfig.THEME_PATH) + File.separator + tplFileName;

		File tplFile = new File(tplFilePath);//模板文件
	...
	private void compile(String tplFileName, File tplFile) throws SystemException, IOException {
		...
		File f = new File(WebRealPathHolder.REAL_PATH + "themes" + File.separator + "common" + File.separator + "function.ftl");
