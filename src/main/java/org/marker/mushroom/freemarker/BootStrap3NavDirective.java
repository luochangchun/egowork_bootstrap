...
public class BootStrap3NavDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		MessageWrapperModel model = (MessageWrapperModel) ActionContext.getReq().getAttribute(SendDataToView
																								  .KEY_MESSAGE_CONTEXT);
			...
			if (hasChild) {
				...
				for (ChannelItem citem : citems) {
					...
					str.append("      <li><a href=\"")
					   ...
					   .append(".html")
					   .append("\">")
					   .append(model.get(cc.getLangkey()))
					   .append("</a></li>\n");
				}
				str.append("    </ul>\n");
			}
