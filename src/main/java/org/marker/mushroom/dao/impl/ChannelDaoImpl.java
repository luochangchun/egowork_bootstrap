...
public class ChannelDaoImpl extends DaoEngine implements IChannelDao {
	...
	public List<Channel> findAll() {
		return jdbcTemplate.query("select * from " + getPreFix() + "channel", new RowMapperChannel());
	}
	...
	public List<Channel> findValid() {
		return jdbcTemplate.query("select * from " + getPreFix() + "channel" + " where hide=?", new RowMapperChannel(), 1);
	}
